...
const SignIn = () => {
    const {
        signUp, signIn, signOut, signInWithPopup, signInEmail, setSignInEmail, signInPass, setSignInPass, signInWithGoogle
        ...
        <div className="profilePageDiv">
            ...
            <div className="signUpDiv">
                ...
                <div className="formDiv">
                    ...
                    <input type="text" value={signInEmail}
                        onChange={
                            (e) => {
            ...
            <div className="formDiv">
                ...
                <input type="password" value={signInPass}
